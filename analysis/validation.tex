...
\centering
  ...
  \caption{Number of selected events after selection and rectangular cuts corresponding to an exposure of $2.3\times10^{20}$ NuMI POT in neutrino mode.}\label{fig:numi_nue}
\end{figure}
