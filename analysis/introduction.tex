...
As an example, Figure \ref{fig:evd} shows a simulated $\nu_{e}$ CC0$\pi$-Np event display on the collection plane with an electron and two protons in the final state, with the corresponding reconstructed shower and reconstructed tracks. In this case, the \mccorrect{pattern} recognition is able to correctly identify the electromagnetic shower and both proton tracks.
