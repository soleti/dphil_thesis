...
\begin{table}[htbp]
   ...
   >{\raggedleft\arraybackslash}p{0.16\linewidth}}
     ...
     \midrule
     Data beam-on & 16 & 11 \\
     Data beam-off & 2.8 & 0.5 \\
     $\nu_e$~CC0$\pi$-Np & 3.2 & 4.4 \\
     $\nu_e$~CC & 0.8 & 1.5 \\
     Beam intrinsic $\nu_{\mu}$ & 4.5 & 1.7 \\
     Beam intrinsic NC & 2.8 & 1.4 \\
     Outside fid. vol. & 0.1 & 0.0 \\
     Cosmic & 0.6 & 0.2 \\
     Cosmic contaminated & 0.4 & 0.2 \\
     \midrule
     Beam-on - beam-off & 13.2 & 10.5 \\
     Total Monte Carlo & 13.1 & 9.4 \\
     \bottomrule
   \end{tabular}
\end{table}
